-- =====================================================================
-- 026: разбор общего альбома — приветствие, обложка, порядок, кто что прислал.
--
...
/**
 * Полное тело. Отличие от версии 025 — одно: обложку видит всякий, кто может
...
/**
 * Полное тело get_album. Отличия от версии 025:
